...
plt.legend()
plt.savefig("results/img/NN_scatter_plot_no_clustering.png", bbox_inches='tight')
plt.close()
...
plt.gca().add_patch(rect)
plt.legend()
plt.savefig("results/img/NN_delta_scatter_plot_no_clustering.png", bbox_inches='tight')
plt.close()
...
plt.savefig("results/img/NN_loss_curves_no_clustering.png", bbox_inches='tight')
plt.close()
...
plt.savefig("results/img/NN_MAE_curves_no_clustering.png", bbox_inches='tight')
plt.close()
...
fields = [
    (mesh_low_z, 'U', r'$|U|$', 'results\\img\\predicted_U_field_xz_no_clustering.png'),
    (mesh_low_z, 'nut', r'$\nu_{t,ML}$', 'results\\img\\predicted_nut_field_xz_no_clustering.png'),
    (mesh_low_z, 'k', r'$k$', 'results\\img\\predicted_k_field_xz_no_clustering.png'),
]
