...
\usepackage[protrusion=true]{microtype}       % migliora la giustificazione (protrusion, XeLaTeX)

% ---------- Graphics ----------
\usepackage{graphicx}
\usepackage{subcaption}
\usepackage{longtable}          % multi-page cost-model table (introduction)
...
%%%introduction
\input{introduction/introduction_new.tex}
%%%methodology
\input{methodology/methodology.tex}
%%%case study
\input{case_study/case_study.tex}
%%%results
