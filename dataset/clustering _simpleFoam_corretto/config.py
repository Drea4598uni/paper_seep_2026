...
inputDict = {
    ...
    "turbineRadius": 63,
    #################################################
    "outputPath": "output_seep/", # ALWAYS USE ABSOLUTE PATHS
    ...
    "mask": True, # if True, data are parsed through a mask for avoiding the NaN values
    ...
    "variabili_CM": ['Ux','Uy','Uz','Ut','Ur','p','k','nut'], # list of features to be used in the correlation matrix (normalized)
